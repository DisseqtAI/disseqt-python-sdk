...
TOOL_CALLS_GOOD = [
    ...
    },
    {
        ...
        "args": {"max_price": 3000, "currency": "GBP"},
        "result": "success",
    },
    {
        "tool": "book_flight",
        "args": {"flight_id": "JL402", "passenger": "John Doe"},
        "result": "success",
    },
]
...
TOOL_CALLS_WITH_FAILURES = [
    {
        "tool": "search_flights",
        "args": {"from": "LHR", "to": "NRT", "date": "2026-02-02"},
            ...
            data=AgenticBehaviourRequest(
                ...
                reference_data={
                    "expected_tool_calls": [
                        {
                            "tool": "search_flights",
                            "args": {"from": "LHR", "to": "NRT", "class": "business"},
                        },
