...
def main() -> None:
    ...
    # ------------------------------------------------------------------
    _run(client, InputPromptInjectionValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, InvisibleTextValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, GenderBiasValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, RacialBiasValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, PoliticalBiasValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, IntersectionalityValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, HateSpeechValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, SexualContentValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, TerrorismValidator(
        data=InputValidationRequest(
    ...
    # ------------------------------------------------------------------
    _run(client, ChildSafetyValidator(
        data=InputValidationRequest(
