...
def main() -> None:
    ...
    # Stray trailing commas here turned these into single-element tuples,
    # not strings — the Client then sent tuple objects in the auth headers
    # and the server rejected them.
