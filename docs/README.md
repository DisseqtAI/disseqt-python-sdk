...
| [realtime-policies.md](./realtime-policies.md) | Policy-governed `validate()`: bind a dashboard policy and it decides which validators run, thresholds, skips; discovery, agentic, error handling |
